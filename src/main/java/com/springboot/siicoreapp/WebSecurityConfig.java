...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers("/index","/home","/","/css/**","/js/**","/images/**","/portada/**","/fproductos","/contactomail","/contactomail/","/sendMails")
		.permitAll()
	...
	public void configurerSecurityGlobal(AuthenticationManagerBuilder builder) throws Exception {
		...
		.authoritiesByUsernameQuery("SELECT u.username, r.rol FROM roles r INNER JOIN users u ON r.id=u.id WHERE u.username=?");
	}
